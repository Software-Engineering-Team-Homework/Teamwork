...
public class modify_title {
    public static void modify(int user_id,int reminder_id,String new_title) throws Exception {
        ...
        try{
        String sql = "update reminders set title = ? where user_id = ? and reminder_id = ?";//更改内容
